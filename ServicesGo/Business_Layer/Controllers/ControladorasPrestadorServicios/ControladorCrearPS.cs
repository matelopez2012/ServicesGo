...
namespace ServicesGo.Business_Layer.Controllers.ControladorasPrestadorServicios
{
    public  class ControladorCrearPS
    {
        ...
        public  void crearPrestadorServicios(Cuenta cuentaRef, string nombre, string apellidos, string cedula,
        ...
        {
            if (validarPS(cedula) && validarCuenta(cuentaRef.NombreUsuario))
            {

                db.PrestadoresServicios.Add(new PrestadorServicios(cuentaRef, nombre, apellidos, cedula,
        ...
        public  void crearCuenta(int id, string nombreUsuario, string clave, string rol, bool estado)
        {
            db.Cuentas.Add(new Cuenta(id, nombreUsuario, clave, rol));
            db.SaveChanges();
        }
