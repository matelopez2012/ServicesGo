...
namespace ServicesGo.Controllers
{
    public class DocumentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombreDoc,ruta,s")] Documento documento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombreDoc,ruta,s")] Documento documento)
        {
            if (ModelState.IsValid)
            {
